...
% If you decide to re-allocate a device handle for this device, it will get a different handle.
...
%   So, 0 for all good, and pretty much anything else for fail.
    ...
    if(isunix)
        fail = calllib('liboapi', 'OptotrakDeviceHandleFree', nDeviceHandleId);
    else
        if(new_or_old)
