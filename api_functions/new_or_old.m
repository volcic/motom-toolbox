...
%NEW_OR_OLD
% [ binary_answer ] = new_or_old( )
% ... checks whether the 32 or the 64-bit libraries are used.
...
%   be used. This is to make sure the appropriate Windows library is used.
%   Linux users should not worry about it.
