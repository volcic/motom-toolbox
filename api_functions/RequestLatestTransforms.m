...
% [ fail ] = RequestLatestTransforms(  )
% This function tells the Optotrak system to prepare to send the freshest 6D rigid body data available.
...
% Make sure you wait until DataIsReady() says so, and then you can call DataReceiveLatestTransforms().
