...
%DATABUFFERSTART
% [ fail ] = DataBufferStart(  )
% This function starts the downloading ('spooling') the data from the Optotrak device to all the allocated locations on the host computer.
