...
%OPTOTRAK_GET_VIRTUAL_MARKER_COORDS This is function that calculates the X-Y-Z coordinates of a virtual marker, using the given virtual marker definition and the translation and rotiation matrices.
