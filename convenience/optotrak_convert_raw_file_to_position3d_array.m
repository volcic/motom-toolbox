...
% OPTOTRAK_CONVERT_RAW_FILE_TO_POSITION3D_ARRAY This function reads a raw data file, and it converts the raw (or centroid) data to X-Y-Z triplets for each marker.
