...
% DATAGETLATESTTRANSFORMS2_AS_ARRAY This function is written in C, and it converts the position of all the rigid bodies in the system that has already been captured.
