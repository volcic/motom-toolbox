...
% operations.
    ...
    if(number_of_cameras > 1)
        ...
        fprintf('There will be a countdown in a dialogue box. When this dialogue box disappears, the recording begins. When the dialogue box re-appears, the recording has finished.\n')
