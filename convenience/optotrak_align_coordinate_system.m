...
%OPTOTRAK_ALIGN_COORDINATE_SYSTEM This is a wrapper function for nOptotrakAlignSystem(), The problem is that the AlignParametersStruct typedef is incorrectly read into Matlab.
