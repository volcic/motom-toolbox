/*
 * DataGetLatestTransforms2_as_array.c - Converts and already fetched rigid body data.
 *
 *
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    fail = DataGetLatestTransforms2(&frame_counter, &number_of_rigid_bodies, &flags, &rigid_transforms, &positions);
