% If you have a single camera, it
%   will align the coordinate system of the rigid body you strategically
%   placed in the world to the camera's global coordinate system.
% If you have many cameras, you will need to move the rigid body around.
% I also added some more bits to the error management, as new users are
% most likely start with this script.


%Requirements are:
% A working data acquisition file
% A working ridid body and its definition as a rigid body file
% Knowing what you are doing :)

%% Starting the madness.

%This clears the files previously generated.
clear all;
clc;
...
config_file = 'this_works_with_the_ndi_cube'; %Supply the config file without extension.
