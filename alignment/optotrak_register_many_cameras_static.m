...
config_file = 'this_works_with_the_ndi_cube.ini'; %I tailored this for my 10 marker setup. Change it to your own. Make sure all markers are visible and bright enough.
...
rigid_body_file = 'ndi_cube'; %This can be in C:\ngidital\rigid, or local. I chose local.
